...
if __name__=='__main__':
    ...
    #SF_path = '/Users/amanda/REPOSITORIES/mtuq_supp/greens_functions_libraries/specfem/cartesian_force/PROCESSED_2021'
    SF_path = './SPECFEM_GF'
    ...
    #grid = Grid(dims=('F0','phi','h'),coords=(1.00e11,278,-0.9659),callback=to_force)
